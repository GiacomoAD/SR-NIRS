...
"}")
        ...
        self.widget.setStyleSheet(u"background-color: rgb(39, 44, 54);\n"
"	padding: 10px;\n"
"	border-radius: 5px;\n"
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_credits.setText(QCoreApplication.translate("MainWindow", u"Base layout  by: Wanderson M. Pimenta", None))
